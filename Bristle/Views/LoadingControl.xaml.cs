...
namespace LoadingSpinner
{
    ...
    public partial class LoadingControl : UserControl
    {
        ...
        {
            var loadingControl = (LoadingControl)d;
            int newRadius = (int)(loadingControl.GetValue(DiameterProperty)) / 2;
            return newRadius;
        }
        ...
        {
            var loadingControl = (LoadingControl)d;
            int newInnerRadius = (int)(loadingControl.GetValue(DiameterProperty)) / 4;
        ...
        {
            var loadingControl = (LoadingControl)d;
            int newCenter = (int)(loadingControl.GetValue(DiameterProperty)) / 2;
