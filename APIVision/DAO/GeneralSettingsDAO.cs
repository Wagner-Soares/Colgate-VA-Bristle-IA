...
{
    public class GeneralSettingsDao<TEntity> : IGeneralSettingsDao<TEntity> where TEntity : class
    {
        private readonly ColgateSkeltaEntities _colgateSkeltaEntities;

        public GeneralSettingsDao(ColgateSkeltaEntities colgateSkeltaEntities)
        {
        ...
        public IList<GeneralSettings> GetAllGeneralSettingss()
        {
            return _colgateSkeltaEntities.GeneralSettings.ToList();
        }
    }
}
