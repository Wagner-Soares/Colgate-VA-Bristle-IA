...
{
    public class BristleSetDao<TEntity> : IBristleSetDao<TEntity> where TEntity : class
    {
        private readonly ColgateSkeltaEntities _colgateSkeltaEntities;

        public BristleSetDao(ColgateSkeltaEntities colgateSkeltaEntities)
        {
        ...
        public IList<BristleSet> GetAllBristleSets()
        {
            return _colgateSkeltaEntities.BristleSet.ToList();
        }
    }
}
